						...
						{isCheckingTwitterData && !Pagination ? <TweetSkeleton /> : 
							<div className="w-full">
								...
								: <div className="w-full text-base text-center max-w-md mx-auto p-4 md:p-6">
									...
									You don't have any tweets from <span className="font-semibold">Insperr</span>, try to generate some and turn on <span className="font-semibold">Auto-Post</span> to schedule and see your realtime custom tweets.
								</div>}
							</div>
						}
					</div>
