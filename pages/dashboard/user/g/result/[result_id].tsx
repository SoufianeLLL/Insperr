			...
			<div className="w-full pb-3 overflow-hidden">
				...
				<>
					<div className="heading w-full">
						<div className="text-xl md:text-2xl font-semibold w-full flex items-center gap-3">Output Result</div>
					</div>
                    {!result?.error && 
                    <div className="w-full mt-5">
                        <div className="w-full lg:flex lg:items-start lg:gap-12 mt-5">
                            <div className="shrink w-full rounded-xl">
                                ...
                                <div className="w-full mt-5">
                                    <div className="w-full font-somibold text-base">Keyword:</div>
                                    <div className="w-full mt-1 text-lg md:text-xl font-semibold capitalize">{result?.keyword}</div>
                                </div>
                                <div className="w-full mt-5">
                                ...
                                :
                                    <div className="w-full">
                                        <div className="w-full mt-2 text-base inline-block">
                                            ...
                                            <div className="float-left">Tweeted successfullu</div>
                                        </div>
                                    </div>
                                }
                            </div>
