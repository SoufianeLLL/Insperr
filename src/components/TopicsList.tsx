			...
			<>
				<div className="w-full">
					<div className="mt-8 w-full">
						<div className="w-full border-t border-zinc-200 my-5 list-of-topics">
							<div className="letter text-4xl md:text-5xl my-5 fontBold hidden"></div>
							<div className="mt-5 w-full text-zinc-500 columns-1 sm:columns-2 md:columns-3 lg:columns-4 gap-y-2 gap-x-6">
								{Topics?.map((topic, i) => {
