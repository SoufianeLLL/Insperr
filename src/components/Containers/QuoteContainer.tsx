...
const QuoteContainer = ({ id, quote, type='custom', withAuthor=true, classes=null, callback=null, mutate=null }) => {
	...
	if (type === 'custom') {
		return <div className={`quote_${quote?.id} inline-block mb-7 w-full max-w-2xl rounded-2xl shadow hover:shadow-lg border border-slate-100 p-5 md:p-8 bg-white`}>
